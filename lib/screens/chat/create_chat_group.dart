          ...
          return Padding(
            ...
            child: PrimaryButton(
              ...
              onPressed: isButtonDisabled
                  ...
                  : () async {
                      developer.log(
                        'CreateChatGroup - Create group button pressed',
                      );
                      ...
                      if (success && mounted) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(context.tr('create_group_success')),
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(context.tr('create_group_failed')),
                            backgroundColor: AppColors.warning,
                          ),
                        );
                      }
            ...
            child: Column(
              ...
              children: [
                ...
                CustomTextField(
                  ...
                  onChanged: (value) {
                    setState(() {}); // Update the state to show/hide the button
                  },
                ),
