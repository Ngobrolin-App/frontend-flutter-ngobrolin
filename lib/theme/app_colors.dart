...
class AppColors {
  ...
  static const Color backgroundGeneral = Color(0xFFFFFFFF);
  static const Color messageRead = Color(0xFF2196F3);
  ...
  static const Color textFieldLightGrey = Color(0xFFF5F5F5);
}
